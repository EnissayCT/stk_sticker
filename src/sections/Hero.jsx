...
const Hero = () => {
  const [bigShoeImg, setBigShoeImg] = useState(card1);
    ...
    >
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28'>
        ...
        <h1 className='mt-2 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold'>
          ...
          <br />
          <span className='text-red-600 inline-block mt-3'>STK</span> Stickers
        </h1>
        <p className='font-montserrat text-black text-lg leading-8 mt-6 mb-14 sm:max-w-sm'>
          Discover stylish Sticker arrivals, quality products, and innovation for
          your active life.
        </p>
